...
React will update and re-render our components
Component takes paramters called props
returns views via render

Render returns a description of what you want to see on the screen

Components remember things with a "state"
...
Immutability: can be used to detect changes
